...
- **Preview** (`oci://ghcr.io/yawlabs/charts/mcp-hosting --version 0.2.2+<sha>`) — every push to `master` that touches `helm/`. Useful for canary'ing chart changes before they cut a tag. Don't pin production to one of these.
